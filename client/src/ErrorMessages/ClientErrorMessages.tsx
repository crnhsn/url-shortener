...
export const CUSTOM_ALIAS_NOT_ALPHANUMERIC_OR_TOO_LONG_MESSAGE = `The custom alias must be alphanumeric and smaller than ${MAX_ALIAS_LENGTH} characters. Please choose another alias.`;
